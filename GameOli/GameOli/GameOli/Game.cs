...
namespace GAME
{
    class Game : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            CaméraJeu = new CaméraSubjectivePhysique(this, caméraPosition, caméraTarget, StaticObjectList, DynamicObjectList, INTERVALLE_MAJ_STANDARD);
        ...
        private void AddForeground2D()
        {
            /// Test Statistics
            {
                ...
                Components.Add(new ScreenMessage(this, CaméraJeu, null, "InterpolationModifier", "Calibri18", 0, 0 * OFFSET_Y, INTERVALLE_MAJ_STANDARD));
                Components.Add(new ScreenMessage(this, CaméraJeu, null, "Sensitivity", "Calibri18", 0, 1 * OFFSET_Y, INTERVALLE_MAJ_STANDARD));
                Components.Add(new ScreenMessage(this, CaméraJeu, null, "Position", "Calibri18", 0, 2 * OFFSET_Y, INTERVALLE_MAJ_STANDARD));
                Components.Add(new ScreenMessage(this, CaméraJeu, null, "Direction", "Calibri18", 0, 3 * OFFSET_Y, INTERVALLE_MAJ_STANDARD));
                Components.Add(new ScreenMessage(this, CaméraJeu, null, "Velocity", "Calibri18", 0, 4 * OFFSET_Y, INTERVALLE_MAJ_STANDARD));
                Components.Add(new ScreenMessage(this, CaméraJeu, null, "AirTime", "Calibri18", 0, 5 * OFFSET_Y, INTERVALLE_MAJ_STANDARD));
                Components.Add(new ScreenMessage(this, CaméraJeu, null, "IsOnFloor", "Calibri18", 0, 6 * OFFSET_Y, INTERVALLE_MAJ_STANDARD));

                // Saving Loading Message
                SavingMessage = new ScreenNotification(this, CaméraJeu, "Saved", null, "Calibri18", 0, 0.9f * this.Window.ClientBounds.Height, INTERVALLE_MAJ_STANDARD, 1.0f);
                SavingMessage.Visible = false;
                Components.Add(SavingMessage);

                LoadingMessage = new ScreenNotification(this, CaméraJeu, "Loaded", null, "Calibri18", 0, 0.9f * this.Window.ClientBounds.Height, INTERVALLE_MAJ_STANDARD, 1.0f);
                LoadingMessage.Visible = false;
                Components.Add(LoadingMessage);

                ResetMessage = new ScreenNotification(this, CaméraJeu, "Level reset", null, "Calibri18", 0, 0.9f * this.Window.ClientBounds.Height, INTERVALLE_MAJ_STANDARD, 1.0f);
                ResetMessage.Visible = false;
                Components.Add(ResetMessage);

                // Other Stats
                Components.Add(new AfficheurFPS(this, "Calibri18", INTERVALLE_MAJ_STANDARD));
            }
