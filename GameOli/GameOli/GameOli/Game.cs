...
namespace GAME
{
    class Game : Microsoft.Xna.Framework.Game
    {
        ...
        Model ModelTerrain { get; set; }
        MeshTerrain Terrain { get; set; }
        ...
        protected override void Initialize()
        {
            ...
            Vector3 positionCaméra = new Vector3(0, 150, 0);
            ...
            #region Terrain
            ModelTerrain = Content.Load<Model>("Textures/Terrain");
            Terrain = new MeshTerrain(this, ModelTerrain, CaméraJeu);
            #endregion
