...
namespace TOOLS
{
    ...
    public class Afficheur : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public Afficheur(Game game, float scale, string nomTexture, Vector2 position)
            : base(game)
        {
            Scale = scale;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            SpriteManager.Begin();
            SpriteManager.Draw(ObjectTexture, Position, Color.White);
            SpriteManager.End();
