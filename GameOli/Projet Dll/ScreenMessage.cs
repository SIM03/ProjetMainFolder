...
namespace TOOLS
{
    public class ScreenMessage : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        const float PETITE_HOMOTHÉTIE = 0.8f;
        const float AVANT_PLAN = 0f;

        protected float IntervalleMAJ { get; set; }
        protected float ElapsedTimeSinceUp { get; set; }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            GestionSprites.DrawString(SpriteFont, Message, MessagePosition, FontColor, AUCUNE_ROTATION,
