...
namespace TOOLS
{
    ...
    public class TextBox : IKeyboardSubscriber
    {
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            spriteBatch.Draw(_textBoxTexture, new Rectangle(X, Y, Width, Height), new Rectangle(0, Highlighted ? (_textBoxTexture.Height / 2) : 0, _textBoxTexture.Width, _textBoxTexture.Height / 2), Color.White,0f,Vector2.Zero,SpriteEffects.None,0f);
