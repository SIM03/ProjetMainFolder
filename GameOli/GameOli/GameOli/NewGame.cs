...
//            //Staticobject
//            TextFileManager.ReadPhysicalObjects(out StaticObjectList);
...
//                SavingMessage = new ScreenNotification(this, CaméraJeu, "Saving...", null, "Calibri18", 0, 0.9f * this.Window.ClientBounds.Height, INTERVALLE_MAJ_STANDARD, 2.0f);
//                SavingMessage.Visible = false;
//                Components.Add(SavingMessage);

//                LoadingMessage = new ScreenNotification(this, CaméraJeu, "Loading...", null, "Calibri18", 0, 0.9f * this.Window.ClientBounds.Height, INTERVALLE_MAJ_STANDARD, 2.0f);
